...
import ArlstmCovnetLstmTtvTttvASixMonth from '../arlstmcovnetlstmttvtttvChart/ArlstmCovnetLstmTtvTttvASixMonth'
import { NavLink } from 'react-router-dom';
function ArlstmCovnetLstmTtvTttvSixMonth() {
    return (
        <div className='ArlstmSixMonth'>
            ...
            <div className="arlstmTop">
                ...
                <div className="arlstmBottom">
                    <ArlstmCovnetLstmTtvTttvASixMonth/>
                </div>
            </div>
        </div>
    )
...
export default ArlstmCovnetLstmTtvTttvSixMonth
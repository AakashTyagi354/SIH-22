...
import Analysicslstmarlstmcovnetttv from './lstmarlstmcovnetttvCharts/Analysicslstmarlstmcovnetttv'

function Olstmarlstmcovnetttv() {
    ...
    return (
        <div>
            ...
            <div className="iomoduleBottom">
                <Analysicslstmarlstmcovnetttv/>
            </div>
        </div>
    )
}

export default Olstmarlstmcovnetttv
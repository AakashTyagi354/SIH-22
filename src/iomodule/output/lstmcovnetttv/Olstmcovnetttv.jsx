...
import Analysicslstmcovnetttv from './lstmcovnetttvCharts/Analysicslstmcovnetttv'

function Olstmcovnetttv() {
    ...
    return (
        <div>
            ...
            <div className="iomoduleBottom">
                <Analysicslstmcovnetttv/>
            </div>
        </div>
    )
}

export default Olstmcovnetttv
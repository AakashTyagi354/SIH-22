...
import Analysicscovnetttvtttv from './covnetttvtttvCharts/Analysicscovnetttvtttv'

function Ocovnetttvtttv() {
    ...
    return (
        <div>
            ...
            <div className="iomoduleBottom">
                <Analysicscovnetttvtttv/>
            </div>
        </div>
    )
}

export default Ocovnetttvtttv
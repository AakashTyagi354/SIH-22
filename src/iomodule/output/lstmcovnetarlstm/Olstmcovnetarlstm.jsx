...
import Analysicslstmcovnetarlstm from './lstmcovnetarlstmCharts/Analysicslstmcovnetarlstm'

function Olstmcovnetarlstm() {
    ...
    return (
        <div>
            ...
            <div className="iomoduleBottom">
                <Analysicslstmcovnetarlstm/>
            </div>
        </div>
    )
}

export default Olstmcovnetarlstm
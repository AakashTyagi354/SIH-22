...
import Analysicslstmcovnettttv from './lstmcovnettttvCharts/Analysicslstmcovnettttv'

function Olstmcovnettttv() {
    ...
    return (
        <div>
            ...
            <div className="iomoduleBottom">
                <Analysicslstmcovnettttv/>
            </div>
        </div>
    )
}

export default Olstmcovnettttv
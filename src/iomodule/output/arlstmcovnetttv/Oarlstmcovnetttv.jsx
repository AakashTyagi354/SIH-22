...
import Analysicsarlstmcovnetttv from './arlstmcovnetttvCharts/Analysicsarlstmcovnetttv'

function Oarlstmcovnetttv() {
    ...
    return (
        <div>
            ...
            <div className="iomoduleBottom">
                <Analysicsarlstmcovnetttv/>
            </div>
        </div>
    )
}

export default Oarlstmcovnetttv
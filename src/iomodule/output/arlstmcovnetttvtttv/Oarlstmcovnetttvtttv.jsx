...
import Analysicsarlstmcovnetttvtttv from './arlstmcovnetttvtttvCharts/Analysicsarlstmcovnetttvtttv'

function Oarlstmcovnetttvtttv() {
    ...
    return (
        <div>
            ...
            <div className="iomoduleBottom">
                <Analysicsarlstmcovnetttvtttv/>
            </div>
        </div>
    )
}

export default Oarlstmcovnetttvtttv
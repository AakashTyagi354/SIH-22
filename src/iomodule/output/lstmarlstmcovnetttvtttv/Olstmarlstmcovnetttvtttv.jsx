...
import Analysicslstmarlstmcovnetttvtttv from './lstmarlstmcovnetttvtttvCharts/Analysicslstmarlstmcovnetttvtttv'

function Olstmarlstmcovnetttvtttv() {
    ...
    return (
        <div>
            ...
            <div className="iomoduleBottom">
                <Analysicslstmarlstmcovnetttvtttv/>
            </div>
        </div>
    )
}

export default Olstmarlstmcovnetttvtttv
...
import Analysicslstmarlstmtttv from './lstmarlstmtttvCharts/Analysicslstmarlstmtttv'

function Olstmarlstmtttv() {
    ...
    return (
        <div>
            ...
            <div className="iomoduleBottom">
                <Analysicslstmarlstmtttv/>
            </div>
        </div>
    )
}

export default Olstmarlstmtttv
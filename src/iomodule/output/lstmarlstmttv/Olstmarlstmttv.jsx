...
import Analysicslstmarlstmttv from './lstmarlstmttvCharts/Analysicslstmarlstmttv'

function Olstmarlstmttv() {
    ...
    return (
        <div>
            ...
            <div className="iomoduleBottom">
                <Analysicslstmarlstmttv/>
            </div>
        </div>
    )
}

export default Olstmarlstmttv
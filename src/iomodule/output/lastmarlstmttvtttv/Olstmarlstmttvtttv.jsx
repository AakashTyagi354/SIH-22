...
import Analysicslstmarlstmttvtttv from './lstmarlstmttvtttvCharts/Analysicslstmarlstmttvtttv'

function Olstmarlstmarlstmttv() {
    ...
    return (
        <div>
            ...
            <div className="iomoduleBottom">
                <Analysicslstmarlstmttvtttv/>
            </div>
        </div>
    )
}

export default Olstmarlstmarlstmttv